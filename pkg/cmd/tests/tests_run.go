...
func NewRunOptions(streams genericclioptions.IOStreams) *RunOptions {
	return &RunOptions{
		KubeFrameworkOptions: NewTestFrameworkOptions(),
...
func NewRunCommand(streams genericclioptions.IOStreams) *cobra.Command {
	...
	o.KubeFrameworkOptions.AddFlags(cmd)
...
func (o *RunOptions) Validate(args []string) error {
	...
	errs = append(errs, o.KubeFrameworkOptions.Validate())
...
func (o *RunOptions) Complete(args []string) error {
	if err := o.KubeFrameworkOptions.Complete(); err != nil {
		return err
	}
...
func (o *RunOptions) run(ctx context.Context, streams genericclioptions.IOStreams) error {
	const suite = "Local CSI Driver E2E tests"
	...
	if len(o.ReportDir) > 0 {
		reporterConfig.JUnitReport = path.Join(o.ReportDir, "e2e.junit.xml")
		reporterConfig.JSONReport = path.Join(o.ReportDir, "e2e.json")
	}
